...
{
   //private static PriorityQueue<Customer_6B_Karlekar> q = new PriorityQueue<Customer_6B_Karlekar>();
   private static HeapPriorityQueue<Customer_6B_Karlekar> q = new HeapPriorityQueue<Customer_6B_Karlekar>(); 
   ...
   public static void serve(PriorityQueue<Customer_6B_Karlekar> q, int i)
   {
