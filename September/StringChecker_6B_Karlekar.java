   ...
   //The Design Question.
    public class StringChecker_6B_Karlekar
   {
       public static void main(String [] args)
      {
         ...
         yummyChecker = new AndChecker(new NotChecker(artiChecker), new NotChecker(kChecker));   
   ...
   class AndChecker implements Checker
	{
		public Checker a; 
		public Checker b; 
		public AndChecker(Checker at, Checker bt)
		{
			a = at; 
			b = bt; 
		}
